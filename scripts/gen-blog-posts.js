...
<html lang="ko"><head>
<!-- Microsoft Clarity -->
<script type="text/javascript">(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window,document,"clarity","script","wsg2fdrv80");</script>
<link rel="dns-prefetch" href="https://www.clarity.ms"/>
<!-- Google tag (gtag.js) — ACHAJA GA4 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-XD51EK8KES"></script>
<script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-XD51EK8KES');</script>
...
<footer class="px-margin py-lg border-t border-app-border text-center mt-xl">
  ...
  <p class="mt-xs text-[10px] text-muted-strong">상호: 코하(Koha) · 대표: 김용헌 · 사업자등록번호: 108-16-82025 · 주소: 경기도 남양주시 진접읍 해밀예당1로 145 · 전화: 010-8947-1841 · 이메일: koha3d77@gmail.com</p>
  <p class="mt-xs text-[10px] text-muted">© 2026 ACHAJA by 코하(Koha). All Rights Reserved.</p>
...
const posts = [
  ...
  {
    slug: 'dashcam-buying-guide',
    title: '블랙박스 선택·설치 완벽 가이드 — 화질·전원·각도까지',
    breadcrumb: '블랙박스',
    description: '블랙박스 화질, 2채널 vs 4채널, 상시전원 설치, 추천 각도, 메모리카드 관리까지. 사고 시 증거력을 극대화하는 실전 가이드.',
    ogDesc: '블랙박스 구매·설치 핵심 체크포인트 정리.',
    category: '액세서리',
    icon: 'videocam',
    readTime: 5,
  ...
  <h2>1. 화질 — Full HD 이상이 기본</h2>
  <p>저가 블랙박스(5만 원 이하)는 HD(1280×720) 또는 그 이하인 경우가 많습니다. 야간·우천 시 번호판이 식별 안 돼 증거력이 떨어집니다.</p>
  <ul>
    <li><strong>전방 카메라</strong>: Full HD(1920×1080) 최소, QHD(2560×1440) 권장</li>
    <li><strong>후방 카메라</strong>: 최소 HD, Full HD 권장</li>
    <li><strong>HDR / WDR</strong>: 역광·터널 출입 시 화이트아웃 방지 필수</li>
    <li><strong>야간 모드</strong>: STARVIS·Sony 센서 채택 모델이 야간 화질 우수</li>
  </ul>

  <h2>2. 채널 수 — 2채널이 가성비 정답</h2>
  <p>채널 수가 많을수록 사각지대가 줄지만 비용·전력 소모도 증가합니다.</p>
  <ul>
    <li><strong>1채널 (전방만)</strong>: 가장 저렴하나 후방 추돌·뺑소니 입증 불가. 비추천.</li>
    <li><strong>2채널 (전후방)</strong>: 가장 일반적, 가성비 최고. 일반 운전자에 충분.</li>
    <li><strong>3채널 (전후+실내)</strong>: 택시·렌터카·우버형. 일반 차량은 불필요.</li>
    <li><strong>4채널 (전후좌우)</strong>: 트럭·버스·고가 차량 보호용. 사이드 미러 사고 입증 강력.</li>
  </ul>

  <h2>3. 전원 방식 — 상시전원이 핵심</h2>
  <p>시거잭 전원만 사용하면 시동 끄면 녹화가 멈춰 <strong>주차 중 사고·뺑소니를 못 잡습니다</strong>. 반드시 상시전원 설치를 권장합니다.</p>
  <ul>
    <li><strong>상시전원 케이블</strong>: 1.5~3만 원, 자동 차단 기능(저전압 보호) 필수</li>
    <li><strong>주차 모드</strong>: 충격 감지 시 5~30초 녹화. 모션 감지보다 안정적</li>
    <li><strong>저전압 차단 설정</strong>: 12.0~12.4V로 설정 (배터리 방전 방지)</li>
    <li><strong>보조 배터리</strong>: 장기 주차 시 30~50만 원 외장 배터리 추가 가능</li>
  </ul>

  <h2>4. 설치 위치와 각도</h2>
  <p>블랙박스를 잘못 달면 시야 가림 또는 사각지대 발생. 다음 가이드를 따르세요.</p>
  <h3>전방 카메라</h3>
  <ul>
    <li>위치: 룸미러 우측 상단(운전석 시야 방해 최소화)</li>
    <li>각도: 보닛 약 1/3, 하늘 1/3, 도로 1/3 비율</li>
    <li>차종별 권장 높이: 승용 천장에서 5~10cm, SUV 5~15cm</li>
  </ul>
  <h3>후방 카메라</h3>
  <ul>
    <li>위치: 후방 유리 중앙 상단(와이퍼 영역 안)</li>
    <li>각도: 트렁크 끝 1/3, 후방 도로 2/3</li>
    <li>틴팅 짙은 차량은 빛 투과율 70% 이상 영역에 부착</li>
  </ul>

  <h2>5. 메모리카드 — 클래스10 이상, 정기 포맷</h2>
  <p>메모리카드 불량은 블랙박스 미작동의 70%를 차지합니다.</p>
  <ul>
    <li>용량: 32~128GB (Full HD 2채널 기준 64GB 추천)</li>
    <li>등급: <strong>Class 10 / U3 / V30 이상</strong> 필수 (저가 카드 절대 비추)</li>
    <li>브랜드: SanDisk, Samsung, Lexar 정품. 5년 보증 모델 우선</li>
    <li>관리: <strong>한 달에 한 번 포맷</strong> (블랙박스 본체 메뉴에서)</li>
    <li>교체 주기: 1.5~2년마다 신품 교체 (쓰기 횟수 한계 존재)</li>
  </ul>

  <h2>6. 추천 가격대별 모델군</h2>
  <ul>
    <li><strong>10~20만 원대</strong>: 가성비. 만도·아이로드 입문 모델</li>
    <li><strong>20~40만 원대</strong>: 표준. 파인뷰·아이나비 중상위</li>
    <li><strong>40~80만 원대</strong>: 프리미엄. QHD·4K, ADAS 결합형</li>
    <li><strong>80만 원 이상</strong>: 4채널·LTE 원격 모니터링형</li>
  </ul>
  <p>설치는 자가 설치(시거잭형) 또는 전문점(상시전원·후방배선) 기준 공임 5~10만 원입니다. <strong>처음이라면 무조건 전문점 설치 권장</strong>합니다.</p>`,
  },

  {
    slug: 'window-tinting-law',
    title: '자동차 썬팅 합법 기준과 추천 농도 — 검사 통과·단속 회피',
    breadcrumb: '썬팅',
    description: '자동차 윈도우 틴팅 합법 기준(가시광선 투과율), 앞·옆·뒷유리 차이, 정기검사 통과 농도, 추천 브랜드까지.',
    ogDesc: '자동차 썬팅 법적 한계와 안전·검사 통과 가이드.',
    category: '법규 · 관리',
    icon: 'wb_sunny',
    readTime: 4,
    ctaTitle: 'ACHAJA 정기검사 가이드',
    ctaText: '썬팅이 검사 통과 가능한지, 정기검사 항목과 합격 노하우를 확인하세요.',
    ctaBtn: '검사 가이드',
    ctaHref: '/blog/vehicle-inspection-guide/',
    related: [
      { href: '/blog/vehicle-inspection-guide/', cat: '검사', title: '자동차 정기검사·종합검사 가이드' },
      { href: '/blog/used-car-checklist/', cat: '구매 체크리스트', title: '중고차 살 때 꼭 확인해야 할 10가지' },
    ],
    body: `  <p>자동차 썬팅(윈도우 틴팅)은 <strong>도로교통법 시행규칙 제28조</strong>에 따라 가시광선 투과율 기준이 명확히 정해져 있습니다. 단순히 "짙게 하면 멋지다"라고 생각하다 단속 또는 검사 불합격 처분을 받는 운전자가 많습니다. 합법 기준과 실용 농도를 정리했습니다.</p>

  <h2>법정 가시광선 투과율(VLT) 기준</h2>
  <p>가시광선 투과율(VLT, Visible Light Transmission)은 <strong>유리를 통과하는 빛의 비율</strong>입니다. 100%는 완전 투명, 0%는 완전 차단.</p>
  <ul>
    <li><strong>앞유리</strong>: 70% 이상 (사실상 무틴팅 권장)</li>
    <li><strong>운전석·조수석 옆유리</strong>: 40% 이상</li>
    <li><strong>뒷자리 옆유리·뒷유리</strong>: <strong>제한 없음</strong> (개인 선호로 결정)</li>
  </ul>
  <p>이 기준은 <strong>유리 자체의 투과율 + 틴팅지의 투과율</strong>을 합산한 결과입니다. 신차 유리는 보통 80~85%이므로 35% 농도 틴팅을 부착하면 실측 30~32%로 측정될 수 있습니다.</p>

  <h2>실측 단속과 처벌</h2>
  <p>경찰은 <strong>가시광선 투과율 측정기(VLT 미터)</strong>로 현장 측정합니다. 위반 시 처벌은 다음과 같습니다.</p>
  <ul>
    <li><strong>승용차</strong>: 과태료 2만 원</li>
    <li><strong>승합·화물</strong>: 과태료 2만 원</li>
    <li>정기검사 시 적발 → 즉시 부적합 처리, 재검사 비용 발생</li>
  </ul>
  <p>실제로는 단속이 빈번하지 않지만, <strong>스쿨존·교통사고 처리·음주 단속 시 추가 점검</strong>되는 경우가 많습니다.</p>

  <h2>실용 농도 추천</h2>
  <h3>앞유리</h3>
  <ul>
    <li><strong>50~70% 농도</strong>: 자외선 차단 + 법적 안전. 무난한 선택.</li>
    <li><strong>30~50% 농도</strong>: 시야 흐림 시작, 야간 단속 위험</li>
    <li><strong>30% 이하</strong>: 단속 거의 확실, 야간 운전 위험</li>
  </ul>
  <h3>옆유리(운전석·조수석)</h3>
  <ul>
    <li><strong>35% 농도</strong>: 가장 보편적. 실측 40% 전후로 합법 가능성 높음.</li>
    <li><strong>15~20% 농도</strong>: 흔하지만 법적 위험. 실측 시 위반 가능성.</li>
  </ul>
  <h3>뒷유리·뒷자리 옆유리</h3>
  <ul>
    <li><strong>5~15% 농도</strong>: 합법. 프라이버시·열차단 효과 극대화.</li>
  </ul>

  <h2>검사 통과 노하우</h2>
  <ol>
    <li>검사 1주일 전 가시광선 투과율 측정기로 자가 점검 (대형마트·카센터 보유)</li>
    <li>옆유리 38~42% 측정되면 통과. 35% 미만이면 재시공 고려.</li>
    <li>뒷유리 짙은 농도여도 검사 영향 없음.</li>
    <li>자가 측정 시 클립이 유리에 정확히 부착돼야 정확.</li>
  </ol>

  <h2>썬팅 브랜드와 가격</h2>
  <ul>
    <li><strong>3M</strong>: 검증된 글로벌 브랜드. 50~80만 원(전체).</li>
    <li><strong>레이노</strong>: 국내 인지도 1위. 40~70만 원.</li>
    <li><strong>볼레로·솔라가드</strong>: 가성비. 25~45만 원.</li>
    <li><strong>아이맥스·일반 중국산</strong>: 10~25만 원, 5년 후 자외선 변색 가능.</li>
  </ul>

  <h2>썬팅 보증과 시공 후 관리</h2>
  <ul>
    <li>정품 시공 시 <strong>5~10년 변색·기포 보증</strong></li>
    <li>시공 후 3~7일은 창문 내리지 말기 (접착제 경화)</li>
    <li>주차 시 직사광선 피하면 수명 연장</li>
    <li>유리 청소는 부드러운 천 + 중성 세제 (암모니아 함유 세정제 금지)</li>
  </ul>
  <p>썬팅은 단순한 외관 꾸미기가 아니라 <strong>자외선 차단·열 차단·프라이버시</strong>를 위한 기능성 부품입니다. 합법 기준 안에서 적절한 농도를 선택하면 단속 걱정 없이 5~10년 사용 가능합니다.</p>`,
  },

  {
    slug: 'carhistory-vs-insurance',
    title: '카히스토리 vs 보험개발원 사고이력 — 무엇이 다른가',
    breadcrumb: '사고이력 비교',
    description: '카히스토리(보험개발원 운영) 무료/유료 차이, 정확도, 사각지대. 진짜 사고차 거르는 법까지.',
    ogDesc: '카히스토리·보험개발원 사고이력 시스템 차이와 활용법.',
    category: '사고 이력',
    icon: 'fact_check',
    readTime: 5,
  ...
  <h2>카히스토리란</h2>
  <p>카히스토리(<a href="https://www.carhistory.or.kr/" target="_blank" rel="noopener nofollow">carhistory.or.kr</a>)는 <strong>보험개발원</strong>이 운영하는 자동차 사고이력 통합 조회 서비스입니다. 국내 손해보험사 14곳이 자동차 보험 사고 처리 시 입력한 데이터를 통합해 제공합니다.</p>
  <ul>
    <li>운영 기관: 보험개발원 (KIDI, 금융위원회 산하)</li>
    <li>데이터 출처: 삼성·DB·현대·KB·메리츠 등 국내 손보사 전체</li>
    <li>조회 단위: 차량번호 또는 차대번호(VIN)</li>
  </ul>

  <h2>무료 vs 유료 — 어떤 정보가 다른가</h2>
  <h3>무료 (간이 조회)</h3>
  <ul>
    <li>사고 발생 횟수 (건수만)</li>
    <li>침수 이력 유무 (있음/없음)</li>
    <li>자가용/영업용/리스용도 변경 이력</li>
    <li>전손 처리 여부</li>
  </ul>
  <h3>유료 (정식 리포트, 5,500원)</h3>
  <ul>
    <li>사고일자·수리비 추정액</li>
    <li>피해 부위(앞범퍼/뒷도어/사이드 등)</li>
    <li>주요 부품 교체 이력 (외판/골격)</li>
    <li>침수 등급 (전손/분손)</li>
    <li>도난·차령 변경 이력</li>
  </ul>

  <h2>카히스토리의 한계 — 사각지대</h2>
  <p>"카히스토리에 사고 이력 없음"이라고 안심하면 안 됩니다. 다음의 사고는 <strong>카히스토리에 기록되지 않습니다</strong>.</p>
  <ol>
    <li><strong>자비 수리(보험 미청구) 사고</strong> — 가장 흔한 사각지대. 소액 사고는 보험료 할증을 피하기 위해 자비 처리하는 경우가 많아 기록 없음.</li>
    <li><strong>해외 사고이력</strong> — 수입차의 본국 사고이력은 한국 시스템에 없음.</li>
    <li><strong>경미한 외판 교환</strong> — 보험사가 단순 외판 교환을 사고로 분류 안 한 경우.</li>
    <li><strong>최근 1주일 이내 사고</strong> — 보험사 → 카히스토리 데이터 동기화에 1~2주 소요.</li>
  </ol>

  <h2>보험개발원 직접 조회 — 카히스토리와 같은가</h2>
  <p>네, 같습니다. <strong>카히스토리는 보험개발원이 만든 대국민 서비스의 브랜드명</strong>입니다. 보험개발원 사이트에서 별도로 조회할 수 있는 건 아니며, <strong>kidi.or.kr → 카히스토리 메뉴</strong>로 들어갑니다.</p>

  <h2>카히스토리에 없는 사고를 잡으려면</h2>
  <ol>
    <li><strong>제조사 정비센터 이력</strong> — 현대·기아·BMW·벤츠 등 공식 센터에 입고된 정비/수리 기록은 별도 조회 가능. 보험 처리 안 했어도 기록됨.</li>
    <li><strong>육안·OBD 점검</strong> — 도장 두께 측정기, 골격 누적 손상 흔적, OBD 진단으로 보완.</li>
    <li><strong>성능점검기록부</strong> — 매도자가 의무적으로 발급. 외판 교환 부위가 색깔로 표시됨.</li>
    <li><strong>같은 차종 동일 매물 비교</strong> — 시세 대비 너무 싼 매물은 보고되지 않은 사고 가능성.</li>
    <li><strong>전문가 점검 의뢰</strong> — 5~10만 원 비용으로 사설 점검사 동행 점검.</li>
  </ol>

  <h2>실전 조회 순서</h2>
  <ul>
    <li>① 카히스토리 무료 조회 (사고/침수 유무 확인)</li>
    <li>② 사고 횟수 0건이면 정식 리포트 생략 가능, 1건 이상이면 5,500원 결제해 상세 확인</li>
    <li>③ 수입차·고가 차량은 본국 이력(Carfax 등) 추가 의뢰 (3~5만 원)</li>
    <li>④ 매도자에게 성능점검기록부 + 정비 영수증 요청</li>
    <li>⑤ 계약 직전 30분 사설 점검 (도장·골격·OBD)</li>
  </ul>
  <p>카히스토리는 <strong>"기본 검증"</strong>이지 <strong>"완전한 진실"</strong>이 아닙니다. 무료 조회는 누구나 활용하되, 카히스토리에만 의존하지 말고 다중 검증으로 사각지대를 메워야 안전한 중고차 거래가 가능합니다.</p>`,
  },

  {
    slug: 'traffic-fine-lookup',
    title: '자동차 과태료·범칙금 조회 가이드 — 미납 확인부터 납부까지',
    breadcrumb: '과태료 조회',
    description: '경찰청 이파인, 위택스, 정부24 통한 과태료·범칙금 조회 방법, 차이점, 가산금 회피 시점, 분할납부 신청법.',
    ogDesc: '과태료·범칙금 조회와 납부 가이드.',
    category: '법규 · 관리',
    icon: 'gavel',
    readTime: 4,
    ctaTitle: 'ACHAJA 차량 관리 가이드',
    ctaText: '과태료뿐 아니라 차량 정기검사·보험 갱신·세금 납부까지 한눈에 관리하세요.',
    ctaBtn: '관리 가이드',
    ctaHref: '/blog/',
    related: [
      { href: '/blog/insurance-renewal-tips/', cat: '보험', title: '자동차 보험 갱신 시 꼭 챙길 것' },
      { href: '/blog/car-tax-calculator/', cat: '세금', title: '자동차 취득세·등록세 계산법' },
    ],
    body: `  <p>주정차 위반·신호 위반·과속·통행료 미납. 운전을 하다 보면 어느새 모르고 지나친 과태료가 쌓입니다. 모르고 두면 가산금이 매월 추가되고, 출국 금지·차량 압류까지 갈 수 있습니다. 다행히 한국은 <strong>온라인으로 과태료를 5분 안에 조회</strong>할 수 있습니다. 어디서, 어떻게, 어떤 차이가 있는지 정리했습니다.</p>

  <h2>과태료 vs 범칙금 — 무엇이 다른가</h2>
  <table class="w-full text-sm border-collapse my-md">
    <thead><tr class="bg-surface-container-low border-b"><th class="text-left p-2">구분</th><th class="text-left p-2">과태료</th><th class="text-left p-2">범칙금</th></tr></thead>
    <tbody>
      <tr class="border-b"><td class="p-2">대상</td><td class="p-2">차량 소유자</td><td class="p-2">운전자 본인</td></tr>
      <tr class="border-b"><td class="p-2">근거</td><td class="p-2">무인 단속(카메라)</td><td class="p-2">현장 단속(경찰)</td></tr>
      <tr class="border-b"><td class="p-2">벌점</td><td class="p-2">없음</td><td class="p-2">있음</td></tr>
      <tr class="border-b"><td class="p-2">금액</td><td class="p-2">상대적 높음</td><td class="p-2">상대적 낮음</td></tr>
      <tr><td class="p-2">즉결심판</td><td class="p-2">불가</td><td class="p-2">가능</td></tr>
    </tbody>
  </table>
  <p>일반적으로 무인 카메라에 찍힌 신호위반·과속·주정차 위반은 <strong>과태료</strong>로 통지됩니다. 같은 위반도 현장에서 경찰이 적발하면 <strong>범칙금 + 벌점</strong>입니다.</p>

  <h2>과태료·범칙금 조회 사이트 3곳</h2>
  <h3>1. 경찰청 이파인 (efine.go.kr)</h3>
  <p>가장 종합적입니다. 무인 단속 과태료, 운전 면허 정보, 미납 범칙금까지 한 번에.</p>
  <ul>
    <li>조회 가능: 신호·속도·주정차·버스전용차로·과적</li>
    <li>로그인: 공동인증서 또는 간편인증(카카오·네이버·PASS)</li>
    <li>납부: 카드·계좌이체 즉시 가능</li>
  </ul>

  <h3>2. 위택스 (wetax.go.kr)</h3>
  <p>지방세 통합 사이트. 자동차세·주민세·과태료 종합 조회·납부.</p>
  <ul>
    <li>조회 가능: 차량과 관련된 지방세 전액</li>
    <li>특히 자동차세 미납이 있는지 함께 확인 가능</li>
    <li>주차 위반 과태료는 지방자치단체 부과 → 위택스에서 더 빠르게 조회</li>
  </ul>

  <h3>3. 정부24 (gov.kr)</h3>
  <p>전체 행정 서비스 통합 포털. 과태료 외에도 운전면허증 갱신, 자동차 등록증 발급 등 함께 처리.</p>

  <h2>가산금이 붙기 전에 — 납부 기한</h2>
  <p>과태료 통지서를 받은 날부터 납부 기한은 다음과 같습니다.</p>
  <ul>
    <li><strong>0~30일</strong>: 자진 납부 시 <strong>20% 감경</strong> (예: 4만원 → 3.2만원)</li>
    <li><strong>31~60일</strong>: 정상 금액</li>
    <li><strong>61일 이후</strong>: 매월 <strong>가산금 1.2% + 중가산금</strong> 추가 (최대 75%까지)</li>
    <li><strong>1년 이상 미납</strong>: 차량 압류·번호판 영치·신용 정보 등록 가능</li>
  </ul>

  <h2>분할 납부 신청 (생활 자금 부담 완화)</h2>
  <p>과태료가 30만 원 이상이면 분할 납부 신청 가능합니다.</p>
  <ul>
    <li>신청처: 부과 기관(지자체·경찰서)</li>
    <li>최대 분할: 12개월</li>
    <li>증빙: 소득 곤란 증빙(건강보험료 납부 확인서 등)</li>
  </ul>

  <h2>이의 신청 가능한 경우</h2>
  <ol>
    <li>차량 도난 시점에 발생한 위반</li>
    <li>긴급 상황(응급 환자 후송 등) — 의료기록 증빙 필요</li>
    <li>단속 카메라 오작동·번호판 오인식</li>
    <li>차량 매도 후 발생한 위반(이전 등록 지연)</li>
  </ol>
  <p>이의신청은 통지서 수령일로부터 <strong>60일 이내</strong>. 부과 기관에 서면 또는 온라인 제출.</p>

  <h2>중고차 구매 시 미납 과태료 확인</h2>
  <p>차량 명의를 이전하면 과거 과태료도 함께 승계됩니다. 매수 전 반드시 <strong>위택스</strong>에서 차량번호로 미납 내역을 조회하세요. 미납 발견 시 매도자에게 정산 요구 또는 매매가에서 차감 협의해야 합니다.</p>
  <p>한 번에 5분 투자로 과태료 사각지대를 없앨 수 있습니다. 매년 1~2회 정기 점검을 습관화하면 가산금·압류 위험 0%로 차량 운영이 깔끔해집니다.</p>`,
  },
];
